...
HombreSimp(gerardo,araceli).
HombreSimp(teofilo,yola).
HombreSimp(yhony,angela).
HombreSimp(robert,carlita).
HombreSimp(gerardo,kity).
HombreSimp(gerardo,araceli).
HombreSimp(ariel,tiburcia).

MujerSimp(gerardo,araceli).
MujerSimp(teofilo,yola).
MujerSimp(beto,cosuelo).
MujerSimp(grover,mirian).
MujerSimp(robert,araceli).
